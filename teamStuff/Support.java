...
public class Support extends Hero {
	 ...
	 */
	public Support() {
		super(100, "Support", 30, 0, 0, false, 20, 5,new ImageIcon(new ImageIcon(GameEnvironmentGui.class.getResource("/Images/support.png")).getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT)));
	}
