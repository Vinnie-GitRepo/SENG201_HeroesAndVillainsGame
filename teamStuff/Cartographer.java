...
public class Cartographer extends Hero {
	 ...
	 */
	public Cartographer() {
		super(100, "Cartographer", 0, 0, 0, false, 0, 0, new ImageIcon(new ImageIcon(GameEnvironmentGui.class.getResource("/Images/cartographer.png")).getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT)));
	}
}