...
public class EdgyScaryFiendLord extends Hero {
	...
	public EdgyScaryFiendLord() {
		super(150, "Anti Hero", 20, 25, 10, false, 10, 50, new ImageIcon(new ImageIcon(GameEnvironmentGui.class.getResource("/Images/anti-hero.png")).getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT)));
	}
