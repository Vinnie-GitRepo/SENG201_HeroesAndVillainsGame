...
//	}};
	...
	/*public void showHealingItems() {
		...
		switch(choice) {
			case 0 :
				if (healingStockLevel[0] >= 1 && currentTeam.getMoney() >= healingPrice[0]) {
				...
				break;
			case 1 :
				if (healingStockLevel[1] >= 1 && currentTeam.getMoney() >= healingPrice[1]) {
				...
				break;
			case 2 :
				if (healingStockLevel[2] >= 1 && currentTeam.getMoney() >= healingPrice[2]) {
