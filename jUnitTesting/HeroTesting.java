...
public class HeroTesting {
	...
	public void testTank() {
		Tank testHero = new Tank();
	}
	
	
	@Test
	public void testCartographer() {
		Cartographer testHero = new Cartographer();
	}
	
	
	@Test
	public void testSupport() {
		Support testHero = new Support();
	}
	
	
	@Test
	public void testLuckyBoii() {
		LuckyBoii testHero = new LuckyBoii();
	}
	
	
	@Test
	public void testEdgyScaryFiendLord() {
		EdgyScaryFiendLord testHero = new EdgyScaryFiendLord();
	}
